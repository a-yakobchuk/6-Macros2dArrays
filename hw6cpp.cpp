...
int main(int argc, char *argv[])
 ...
 //clock_t dataInputTimer, calculationsTimer;
 ...
 DECLARE_TIMER(calculationsTimer)
 START_TIMER(calculationsTimer) 
 DECLARE_REPEAT_VAR(r2)
 BEGIN_REPEAT_TIMING(REPEATVAL,r2) 
 ...
 END_REPEAT_TIMING     
 STOP_TIMER(calculationsTimer)
     // print the results 
 PRINT_TIMER(calculationsTimer)
 PRINT_RTIMER(calculationsTimer,REPEATVAL)    
